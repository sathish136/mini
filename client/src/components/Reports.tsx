          ...
          <Card className="shadow-sm border border-gray-200">
            <CardContent className="p-8 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-lg text-gray-600">Loading leave report...</div>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="shadow-sm border border-gray-200">
            <CardContent className="p-8">
              <div className="text-center py-12">
                ...
                <div className="text-xl text-gray-500 mb-2">No Leave Records Found</div>
                <div className="text-gray-400">No leave requests found for the selected period.</div>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{totalLeaveRequests}</div>
        ...
        <Card className="shadow-sm border border-gray-200">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-lg">
              ...
              Leave Records ({totalLeaveRequests} entries)
            </CardTitle>
          </CardHeader>
              ...
              <table className="min-w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-gray-50 border-b-2 border-gray-200">
                    ...
                    <th className="px-3 py-2 text-left font-semibold text-gray-700 border-r border-gray-200">Leave Type</th>
                    <th className="px-3 py-2 text-left font-semibold text-gray-700 border-r border-gray-200">Start Date</th>
                    <th className="px-3 py-2 text-left font-semibold text-gray-700 border-r border-gray-200">End Date</th>
                    <th className="px-3 py-2 text-left font-semibold text-gray-700 border-r border-gray-200">Days</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {leaveRequests.map((record: any, index: number) => {
                    const employee = employees?.find((emp: any) => emp.id.toString() === record.employeeId);
                    return (
                      <tr key={index} className="hover:bg-gray-50 transition-colors duration-150">
                        <td className="px-3 py-2 text-gray-700 font-medium border-r border-gray-200">{index + 1}</td>
                        <td className="px-3 py-2 text-gray-900 font-semibold border-r border-gray-200">{employee?.employeeId || record.employeeId}</td>
                        <td className="px-3 py-2 text-gray-900 border-r border-gray-200">{employee?.fullName || 'N/A'}</td>
                        <td className="px-3 py-2 border-r border-gray-200">
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                            record.leaveType === 'annual' ? 'bg-blue-100 text-blue-800 border border-blue-200' :
                            record.leaveType === 'sick' ? 'bg-red-100 text-red-800 border border-red-200' :
                            record.leaveType === 'casual' ? 'bg-green-100 text-green-800 border border-green-200' :
                        ...
                        <td className="px-3 py-2 text-gray-700 font-medium border-r border-gray-200">{record.days}</td>
                        <td className="px-3 py-2 border-r border-gray-200">
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                            record.status === 'approved' ? 'bg-green-100 text-green-800 border border-green-200' :
                            record.status === 'pending' ? 'bg-yellow-100 text-yellow-800 border border-yellow-200' :
                            record.status === 'rejected' ? 'bg-red-100 text-red-800 border border-red-200' :
                            'bg-gray-100 text-gray-800 border border-gray-200'
                          }`}>
                            {record.status}
                          </span>
                        </td>
                        <td className="px-3 py-2 text-gray-700">{record.reason || 'N/A'}</td>
                      </tr>
                    );
                  })}
                </tbody>
